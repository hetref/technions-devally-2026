<<<<<<< HEAD
import { getFollowing } from "@/lib/followeringAction";
...
import {
  ...
  DialogTitle,
  DialogTrigger,
>>>>>>> ad63bf3d082e64b1af06693c6bd8f031388b65dd
            ...
            {!isControlled && (
                children ? (
                    ...
                    <DialogTrigger className={className} disabled={!canView}>
                        <div
                            className={`flex flex-col items-center transition-colors duration-200 ${canView ? "hover:text-blue-600 cursor-pointer" : "cursor-default"
                                }`}
                        >
