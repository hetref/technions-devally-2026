...
const GlassInputWrapper = ({ children, className = "" }) => (
    <div className={`rounded-2xl border border-gray-200 bg-gray-50/50 backdrop-blur-sm transition-colors focus-within:border-violet-400/70 focus-within:bg-violet-500/10 ${className}`}>
        {children}
    </div>
);
...
const BusinessRegistration = () => {
    ...
    const handlePanCheck = async () => {
        ...
        try {
            // Mock API delay for demo realism
            await new Promise(resolve => setTimeout(resolve, 800));

            // Store dummy details for database
            setPanDetails({
                dob: "01/01/1990",
                gender: "M",
                fullName: "DEMO BUSINESS USER",
            });
            ...
            <form className="space-y-5" onSubmit={handleSignUp}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="animate-element animate-delay-400">
                        ...
                        >
                            <GlassInputWrapper>
                                <SelectTrigger className="w-full bg-transparent text-sm p-4 rounded-2xl border-none shadow-none focus:ring-0 focus:ring-offset-0 [&>span]:line-clamp-none h-full">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-center space-x-2">
                            ...
                            <Label
                                ...
                                className="cursor-pointer text-sm text-gray-700 leading-none"
                            >
                ...
                <div className="animate-element animate-delay-800">
                    ...
                    <div className="flex gap-2">
                        ...
                        {panVerified ? (
                            <div className="flex items-center justify-center px-4 py-4 rounded-2xl font-medium border border-green-500 text-green-600 bg-green-50">
                                Verified
                            </div>
                        ) : (
                            <button
                                ...
                                className="px-4 py-4 rounded-2xl font-medium transition-colors bg-black text-white hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed"
                                disabled={isPanVerifying || !panCard || panCard.length !== 10}
                            >
                                {isPanVerifying ? "Verifying..." : "CHECK"}
                            </button>
                        )}
                    </div>
