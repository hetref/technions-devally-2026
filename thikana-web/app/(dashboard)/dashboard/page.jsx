...
const IncomeAnalyticsTab = dynamic(
  () => import("@/components/dashboard/IncomeAnalyticsTab"),
  {
    loading: () => (
      <div className="flex justify-center p-8">
        <Loader />
...
const MembersTab = dynamic(() => import("@/components/dashboard/MembersTab"), {
  loading: () => (
    <div className="flex justify-center p-8">
      <Loader />
    </div>
...
export default function DashboardPage() {
  ...
  const handleTabChange = (value) => {
    if (userRole === "member" && value === "settings") {
